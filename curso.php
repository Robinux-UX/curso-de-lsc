...
<body>
 ...
 ?>
  ...
  <ul class="nav nav-pills" id="myTab" role="tablist">
    <li class="nav-item">
        <a class="nav-link active" width="85%" id="l1-tab" data-toggle="pill" href="#l1" role="tab" aria-controls="l1" aria-selected="true">Leccion 1</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" width="85%" id="l2-tab" data-toggle="pill" href="#l2" role="tab" aria-controls="l2" aria-selected="false">Leccion 2</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" width="85%" id="l3-tab" data-toggle="pill" href="#l3" role="tab" aria-controls="l3" aria-selected="false">Leccion 3</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" width="85%" id="l4-tab" data-toggle="pill" href="#l4" role="tab" aria-controls="l4" aria-selected="false">Leccion 4</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" width="85%" id="l5-tab" data-toggle="pill" href="#l5" role="tab" aria-controls="l5" aria-selected="false">Leccion 5</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" width="85%" id="l6-tab" data-toggle="pill" href="#l6" role="tab" aria-controls="l6" aria-selected="false">Leccion 6</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" width="85%" id="l7-tab" data-toggle="pill" href="#l7" role="tab" aria-controls="l7" aria-selected="false">Leccion 7</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" width="85%" id="l8-tab" data-toggle="pill" href="#l8" role="tab" aria-controls="l8" aria-selected="false">Leccion 8</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" width="85%" id="l9-tab" data-toggle="pill" href="#l9" role="tab" aria-controls="l9" aria-selected="false">Leccion 9</a>
    </li>
  </ul>
...
<div class="tab-content" id="myTabContent">
        ...
        <!--video 1 -->
     <div class="tab-pane fade show" id="l1" role="tabpanel" aria-labelledby="l1-tab">
        <h5 class="h4 mt-2">Leccion 1: Abecedario</h5>
    ...
    <div class="tab-pane fade show" id="l2" role="tabpanel" aria-labelledby="l2-tab">
        <h5 class="h4 mt-2">Leccion 2: Verbos</h5>
        <div class="embed-responsive embed-responsive-16by9 mt-2">
    ...
    <div class="tab-pane fade show" id="l3" role="tabpanel" aria-labelledby="l3-tab">
        <h5 class="h4 mt-2">Leccion 3: Adjetivo</h5>
        <div class="embed-responsive embed-responsive-16by9 mt-2">
    ...
    <div class="tab-pane fade show" id="l4" role="tabpanel" aria-labelledby="l4-tab">
        <h5 class="h4 mt-2">Leccion 4: Saludos y expresiones de costería</h5>
        <div class="embed-responsive embed-responsive-16by9 mt-2">
    ...
    <div class="tab-pane fade show" id="l5" role="tabpanel" aria-labelledby="l5-tab">
        <h5 class="h4 mt-2">Leccion 5: Emociones</h5>
        <div class="embed-responsive embed-responsive-16by9 mt-2">
    ...
    <div class="tab-pane fade show" id="l6" role="tabpanel" aria-labelledby="l6-tab">
        <h5 class="h4 mt-2">Leccion 6: Pronombres</h5>
        <div class="embed-responsive embed-responsive-16by9 mt-2">
    ...
    <div class="tab-pane fade show" id="l7" role="tabpanel" aria-labelledby="l7-tab">
        <h5 class="h4 mt-2">Leccion 7: Familia</h5>
        <div class="embed-responsive embed-responsive-16by9 mt-2">
    ...
    <div class="tab-pane fade show" id="l8" role="tabpanel" aria-labelledby="l8-tab">
        <h5 class="h4 mt-2">Leccion 8: Pronombres interrogativos</h5>
        <div class="embed-responsive embed-responsive-16by9 mt-2">
    ...
    <div class="tab-pane fade show" id="l9" role="tabpanel" aria-labelledby="l9-tab">        
        <h5 class="h4 mt-2">Leccion final: Vocabulario</h5>
        <div class="embed-responsive embed-responsive-16by9 mt-2">
